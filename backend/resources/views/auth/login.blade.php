...
<head>
    ...
    <title>Nomads &mdash; Sign In</title>
    <x-styles.style />
</head>
<body>
    <!-- Main -->
        ...
        <div class="container">
            <div class="row page-login d-flex align-items-center">
                <div class="section-left col-12 col-md-6">
                    <h1 class="mb-4 d-none d-md-block d-lg-block">
                        We explore the new 
                        <br>
                        life much better
                    </h1>
                    <img src="{{ asset('frontend/img/sign_in/img.jpg') }}" class="w-75 d-none d-md-block d-lg-block">
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="mt-5">
                                ...
                                <button type="submit" class="btn btn-login w-100 mt-4">Sign In</button>
